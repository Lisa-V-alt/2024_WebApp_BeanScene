        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SittingStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TableName = table.Column<string>(type: "nvarchar(max)", nullable: false, computedColumnSql: "\r\n            CASE Area\r\n                WHEN 0 THEN 'M'\r\n                WHEN 1 THEN 'O'\r\n                WHEN 2 THEN 'B'\r\n            END + CAST(TableNo AS VARCHAR)")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResStartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Duration = table.Column<int>(type: "int", nullable: false),
                    Source = table.Column<int>(type: "int", nullable: false),
                    SpecialReqs = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Sitting",
                columns: new[] { "SittingId", "EndTime", "SittingStatus", "SittingType", "StartTime" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified), 0, 0, new DateTime(1, 1, 1, 8, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, new DateTime(1, 1, 1, 16, 0, 0, 0, DateTimeKind.Unspecified), 0, 1, new DateTime(1, 1, 1, 12, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, new DateTime(1, 1, 1, 18, 0, 0, 0, DateTimeKind.Unspecified), 0, 2, new DateTime(1, 1, 1, 16, 0, 0, 0, DateTimeKind.Unspecified) }
                });
